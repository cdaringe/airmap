...
export const sensorsRaw = [
  ...
  14923, 142240, 134920, 134636, 134026, 133946, 133373, 133043, 132859, 131585,
  127985, 127467, 126933, 126931, 126495, 126135, 123865, 123163, 122737,
  121349, 121253, 120749, 120479, 119803, 118027, 116617, 116155, 114555,
  114551, 113574, 112728, 112502, 110838, 110690, 110670, 110546, 110510,
  110114, 110060, 108264, 107568, 106966, 10512, 105044, 104320, 104064, 103836,
  103746, 101988, 101699, 101171, 101161, 100949, 100921, 100901, 100895,
  100893, 100885, 100809,
] as const;
